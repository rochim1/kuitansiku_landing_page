...
<head>
    ...
    <title>Email Verifikasi - BMT At Taawun</title>
                ...
                <div class="card bg-white shadow-lg">
                    <div class="card-body px-5">
                        <div class="text-center">
                            ...
                            <h5 class="opacity-75">BMT At Taawun</h5>
                            <small class="opacity-75 fst-italic">konfirmasi lupa password input Email anda yang terdaftar</small>
                        </div>
