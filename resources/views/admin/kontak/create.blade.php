...
<div class="row">
    <div class="col-md">
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ url('admin/kontak') }}" method="POST" autocomplete="off">
                    @csrf
                    <div class="mb-3">
                        <label class="form-label">No Telpon/Kontak<span class="text-danger fs-5">*</span></label><br>
                        <input min="0" type="number" class="form-control @error('no_kontak') is-invalid @enderror" name="no_kontak" value="{{old('no_kontak')}}">
                        @error('no_kontak')
