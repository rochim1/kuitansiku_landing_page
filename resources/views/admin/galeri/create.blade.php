    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="{{ url('admin/galeri') }}" method="POST" autocomplete="off" enctype="multipart/form-data">
                @csrf
                <div class="mb-4">
                    <label class="form-label">Galeri<span class="text-danger fs-5">*</span> <span class="fst-italic small">(jpg, jpeg, png, bmp, gif, svg,
                            webp / 10MB)</span></label>
                    <input type="file" class="form-control @error('gambar_galeri') is-invalid @enderror" name="gambar_galeri">
                    @error('gambar_galeri')
