...
<div class="row">
    <div class="col-md">
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ url('admin/keunggulan') }}" method="POST" autocomplete="off">
                    @csrf
                    <div class="mb-3">
                        <label class="form-label">keunggulan<span class="text-danger fs-5">*</span></label><br>
                        <textarea class="form-control @error('deskripsi_keunggulan') border border-danger @enderror" name="deskripsi_keunggulan" rows="5">{{ old('deskripsi_keunggulan') }}</textarea>
