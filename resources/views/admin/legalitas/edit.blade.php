    ...
    <div class="col-md">
        ...
        <div class="card">
            <div class="card-body">
                ...
                @else
                    <form action="{{ url('admin/legalitas/' . Crypt::encryptString($legalitas->id_legalitas)) }}" method="POST" autocomplete="off">
                        @method('PUT')
                        @csrf
                        <div class="mb-4">
                            ...
                            <option 
                            @if ($item->id_nama_legalitas ==  $legalitas->id_nama_legalitas || $item->id_nama_legalitas == old('judul_legalitas') )
                            selected    
                            @endif 
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('deskripsi_legalitas') border border-danger @enderror" name="deskripsi_legalitas" rows="5">{{ old('deskripsi_legalitas', $legalitas->deskripsi_legalitas) }}</textarea>
