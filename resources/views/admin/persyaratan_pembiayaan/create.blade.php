...
<div class="row">
    <div class="col-md">
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ url('admin/persyaratan_pembiayaan') }}" method="POST" autocomplete="off">
                    @csrf
                    <div class="mb-3">
                        <label class="form-label">persyaratan_pembiayaan<span class="text-danger fs-5">*</span></label><br>
                        <input type="hidden" id="deskripsi_persyaratan_pembiayaan" name="deskripsi_persyaratan_pembiayaan" value="{{ old('deskripsi_persyaratan_pembiayaan') }}">
