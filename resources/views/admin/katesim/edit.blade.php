...
<div class="row">
    <div class="col-md">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="{{ url('/admin/katesim') }}" class="btn btn-danger btn-icon-split">
        ...
        <div class="card">
            <div class="card-body">
                ...
                @else
                    <form action="{{ url('admin/katesim/' . Crypt::encryptString($katesim->id_katesim)) }}" method="POST" autocomplete="off">
                        @method('PUT')
                        @csrf
                        <div class="mb-4">
                            <label class="form-label">Kategori<span class="text-danger fs-5">*</span></label>
                            <input type="text" class="form-control @error('nama_katesim') is-invalid @enderror" name="nama_katesim"
                                value="{{ old('nama_katesim', $katesim->nama_katesim) }}">
                            @error('nama_katesim')
