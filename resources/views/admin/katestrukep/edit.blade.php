    ...
    <div class="col-md">
        ...
        <div class="card">
            <div class="card-body">
                ...
                @else
                    <form action="{{ url('admin/katestrukep/' . Crypt::encryptString($katestrukep->id_katestrukep)) }}" method="POST" autocomplete="off">
                        @method('PUT')
                        @csrf
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control @error('nama_katestrukep') is-invalid @enderror" name="nama_katestrukep"
                                value="{{ old('nama_katestrukep', $katestrukep->nama_katestrukep) }}">
